...
function generateShadow(){
    const shadowParameters = getShadowParameters();
    const boxShadow = createBoxShadow(...shadowParameters); // adding box shadow
    applyShadow(elem, boxShadow);
    updateCode(boxShadow); // Ensure the code text area updates
}

function getShadowParameters(){
